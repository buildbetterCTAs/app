<template>
  <div class="app-content">
    <div v-if="!authenticated" class="hero-body">
      <div class="container has-text-centered">
        <p class="title is-4">Log in to begin building your Call-to-Actions</p>
        <div>
          <a class="button is-primary" @click="auth.login()">Login</a>
        </div>
      </div>
    </div>
    ...
    <div v-if="authenticated">
      ...
      <!-- EDITOR -->
      <div class="container editor-view">
                ...
                <div class="columns" style="margin-bottom: 0;">
                  <div class="column is-one-quarter">
                    <b-field label="Select CTA Type">
                      <b-select expanded v-model="ctaStyle">
